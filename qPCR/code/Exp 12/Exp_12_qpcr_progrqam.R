...
qpcr_data <- read.csv("~/Desktop/CU_coding/qPCR/raw_data/Exp12_4.29.24_.u4cs_20240429_144802_Results_20240429 162252.csv", 
                      skip = skip_meta, 
...
pTRIP_JAK1_WT <- delta_cq_data %>%
  filter(grepl("pTRIP Luciferase", Sample)) ####CHANGE THIS each time
...
# make graph w c892y, note communication
# 
