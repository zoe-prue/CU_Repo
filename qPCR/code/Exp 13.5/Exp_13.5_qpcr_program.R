...
qpcr_data <- read.csv("~/Desktop/CU_coding/qPCR/raw_data/Exp13.5_5.8.2024_u4cs_20240508_130258_Results_20240508 143705.csv", 
                      skip = skip_meta, 
...
my_cols <- c("#648FFF", "#785EF0", "#DC267F", "#FE6100", "#0072B2", "#FFB000", "darkolivegreen2", ) # should be sample length as probe_list
