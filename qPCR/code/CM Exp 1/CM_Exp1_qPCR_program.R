...
qpcr_data <- read.csv("~/Desktop/CU_coding/qPCR/raw_data/CM_Exp1_8.22.2024_U4Cs_20240822_144105_Results_20240822 161500.csv", 
                      skip = skip_meta, 
...
rel_conc_bar_order <- rel_conc_bar + 
  scale_x_discrete(labels = c(
    ...
    "pTRIP JAK1 G1023D" = "G1023D",
    "pTRIP JAK1 R326K" = "R326K"
  ), 
