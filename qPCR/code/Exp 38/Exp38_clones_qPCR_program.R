# my_qPCR_program_Exp_38_clones_GAPDH_ref
# ZMP
# 10/2/2024
...
ctrl_sample = "293T WT" # sample you're making everything "relative" to
plot_title = " mRNA"
fill_color = "#648FFF"
...
graph_rel_conc <- function(rel_conc_data, fill_color, probe) {
  ...
  # Extract group names without numbers at the end
  rel_conc_data$group <- gsub("\\s[0-9]+$", "", rel_conc_data$Sample.x)
