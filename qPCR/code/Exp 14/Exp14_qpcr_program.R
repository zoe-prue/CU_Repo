...
qpcr_data <- read.csv("~/Desktop/CU_coding/qPCR/raw_data/Exp14_5.13.24_u4cs_20240513_174533_Results_20240513 192052.csv", 
                      skip = skip_meta, 
...
rel_conc_bar_order <- rel_conc_bar + 
  scale_x_discrete(labels = c(
    "pTRIP JAK1 WT" = "WT", 
    "pTRIP JAK1 S703I" = "S703I",
    "pTRIP JAK1 R506C" = "R506C", 
    "pTRIP JAK1 N76S" = "N76S",
    "pTRIP JAK1 I359M" = "I359M",
    "pTRIP JAK1 K847E" = "K847E"
    ), 
