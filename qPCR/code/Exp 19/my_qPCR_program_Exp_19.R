...
qpcr_data <- read.csv("~/Desktop/CU_coding/qPCR/raw_data/Exp19_7.5.2024_u4cs_20240705_122917_Results_20240705 140316.csv", 
                      skip = skip_meta, 
...
qpcr_data <- qpcr_data %>%
filter(Sample != "pTRIP JAK1 I578V 2")
