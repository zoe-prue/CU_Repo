...
qpcr_data <- read.csv("~/Desktop/CU_coding/qPCR/raw_data/Exp34_11.22.24_U4Cs_20241122_115455_Results_20241122 133001.csv", 
                      skip = skip_meta, 
...
# troubleshooting removing pTRIP JAK1 Q1016H 2
unique(qpcr_data$Sample)
test_filter <- qpcr_data %>%
