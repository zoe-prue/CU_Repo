...
qpcr_data <- read.csv("~/Desktop/CU_coding/qPCR/raw_data/Exp21_7.18.2024_U4Cs_20240718_120236_Results_20240718 133617.csv", 
                      skip = skip_meta, 
...
rel_conc_bar_order <- rel_conc_bar + 
  scale_x_discrete(labels = c(
    ...
    # "pTRIP JAK1 R69H" = "R69H",
    # "pTRIP JAK1 D99E" = "D99E",
    "pTRIP JAK1 R326K" = "R326K"
    # "pTRIP JAK1 S407F" = "S407F"
  ), 
