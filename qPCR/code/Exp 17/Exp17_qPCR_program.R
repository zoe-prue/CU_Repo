...
qpcr_data <- read.csv("~/Desktop/CU_coding/qPCR/raw_data/Exp17_6.13.2024_u4cs_20240613_153021_Results_20240613 170527.csv", 
                      skip = skip_meta, 
...
rel_conc_bar_order <- rel_conc_bar + 
  scale_x_discrete(labels = c(
    ...
    "pTRIP JAK1 G307S" = "G307S",
    "pTRIP JAK1 R360W" = "R360W",
    "pTRIP JAK1 E459K" = "E459K",
  ...
  # geom_hline(yintercept = 2.503923733, linetype = 'dashed', color = 'black') +  # Add dotted line
  # geom_hline(yintercept = 2.8834201, linetype = 'dashed', color = 'black')  # Add dotted line
rel_conc_bar_order

# rel_conc_bar_order + geom_text(aes(x = 3.6, y = 2.55, label = "Lower Limit Mild GOF"),
#                                hjust = -0.1, vjust = 0) +
#   geom_text(aes(x = 3.6, y = 2.92, label = "Upper Limit Strong GOF"), 
#             hjust = -0.1, vjust = 0)
