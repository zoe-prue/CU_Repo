...
qpcr_data <- read.csv("~/Desktop/CU_coding/qPCR/raw_data/Exp15_5.23.2024_u4cs_20240523_170725_Results_20240523 184242.csv", 
                      skip = skip_meta, 
...
ctrl_sample = "pTRIP Luciferase 0 u/mL IFN-a2b" # sample you're making everything "relative" to
plot_title = " mRNA"
fill_color = "#FE6100"
...
#   geom_text(aes(x = 5.2, y = 2.55, label = "Upper Limit Strong GOF"), 
